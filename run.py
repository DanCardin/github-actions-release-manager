...
parser.add_argument('--bump', type=BumpAmount, default=BumpAmount.minor
                    help='an integer for the accumulator')
parser.add_argument('-D', '--delete-branch', action='store_true',
                    help='sum the integers (default: find the max)')
parser.add_argument('--method', type=MergeMethod, default=MergeMethod.merge,
                    help='sum the integers (default: find the max)')
